...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'about', loadChildren: './about/about.module#AboutModule', data: { name: 'About', icon: ' fa-question-circle' } },
            { path: 'joke', loadChildren: './jokes/jokes.module#JokesModule', data: { name: 'Joker', icon: 'fa-home' } },
            { path: 'formbuiler', loadChildren: './formbuiler/formbuiler.module#FormbuilerModule', data: { name: 'Form builer', icon: 'fa-home' } }
        ]
    }
];
